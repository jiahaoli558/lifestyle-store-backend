...
class User(db.Model):
    ...
    # reviews = db.relationship('Review', backref='user', lazy=True, cascade='all, delete-orphan')  # 暂时注释掉，避免循环引用
...
class Product(db.Model):
    ...
    review_count = db.Column(db.Integer, default=0) # 重命名为review_count避免冲突
    ...
    def to_dict(self):
        return {
            ...
            'rating': self.rating,
            'reviews': self.review_count, # 使用review_count字段
            'isNew': self.is_new,
